    ...
    >
      ...
      >
        ...
        >
          ...
          >
            The operations partner you'd
            <br />
            hire if you could afford one.
          </h2>
          <p
            style={{
              fontSize: 18,
          ...
          >
            Built by an owner who managed 20+ facilities at once, oversaw
            1M+ sq ft of flex industrial, and handled 1,500+ commercial
            leases inside storage properties — renewals, vacancies, rate
            increases, move-outs, all of it. Then he bought his own facility
            and discovered what every independent operator knows: there's no
            one to call. No supervisor. No colleague. No operations team.
            You figure it out or it doesn't get figured out.
          </p>
            ...
            {[
              {
                ...
                desc:
                  "You're the manager, the maintenance guy, the marketer, and the accountant. StorageAlly is the ops partner who handles the parts you don't have time for — and remembers the things you forget.",
              },
              {
                title: "2–5 Location Operators",
                desc:
                  "You've grown past spreadsheets but aren't ready for enterprise software. StorageAlly gives you one dashboard, every facility, every number — built for the way you actually run the business.",
              },
              {
                title: "New Facility Buyers",
                desc:
                  "Just closed on a facility? StorageAlly onboards your operation in an afternoon. Unit mix, vendors, competitor intel, maintenance schedule — running like you've been there for years by the end of week one.",
              },
            ].map((w, i) => (
              <div
                key={i}
